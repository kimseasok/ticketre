...
return [
    ...
    'connections' => [
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'servicedesk'),
        ...
        'pgsql' => [
            ...
            'database' => env('DB_PG_DATABASE', env('DB_DATABASE', 'servicedesk')),
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', env('APP_NAME', 'ServiceDesk').'_database_'),
        ],
        'default' => [
