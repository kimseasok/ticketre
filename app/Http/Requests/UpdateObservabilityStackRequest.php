...
class UpdateObservabilityStackRequest extends ApiFormRequest
{
    ...
    public function rules(): array
    {
        ...
        $stack = $this->route('observability_stack');
        $tenantId = $stack->tenant_id ?? $this->tenantId();
        $brandId = $this->input('brand_id', $stack->brand_id);
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('observability_stacks', 'slug')
            ...
            'status' => ['sometimes', 'required', 'string', Rule::in(self::STATUS_OPTIONS)],
            'logs_tool' => ['sometimes', 'required', 'string', 'max:255', Rule::in(self::LOGS_OPTIONS)],
            'metrics_tool' => ['sometimes', 'required', 'string', 'max:255', Rule::in(self::METRICS_OPTIONS)],
            'alerts_tool' => ['sometimes', 'required', 'string', 'max:255', Rule::in(self::ALERTS_OPTIONS)],
            'log_retention_days' => ['sometimes', 'required', 'integer', 'min:1', 'max:365'],
            'metric_retention_days' => ['sometimes', 'required', 'integer', 'min:1', 'max:365'],
            'trace_retention_days' => ['sometimes', 'nullable', 'integer', 'min:1', 'max:180'],
            'estimated_monthly_cost' => ['sometimes', 'nullable', 'numeric', 'min:0'],
            'trace_sampling_strategy' => ['sometimes', 'nullable', 'string', 'max:255'],
            'decision_matrix' => ['sometimes', 'nullable', 'array', 'min:1'],
            ...
            'security_notes' => ['sometimes', 'nullable', 'string'],
