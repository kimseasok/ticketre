...
class UpdateRedisConfigurationRequest extends ApiFormRequest
{
    ...
    public function rules(): array
    {
        ...
        $configuration = $this->route('redis_configuration');
        $tenantId = $configuration?->tenant_id ?? $this->tenantId();
        $brandId = $this->input('brand_id', $configuration?->brand_id);
        ...
        return [
            ...
            'slug' => [
                ...
                Rule::unique('redis_configurations', 'slug')
                    ->ignore($configuration?->getKey(), 'id')
            ...
            'cache_connection_name' => ['sometimes', 'string', 'max:64'],
            'cache_host' => ['sometimes', 'string', 'max:255'],
            'cache_port' => ['sometimes', 'integer', 'min:1', 'max:65535'],
            'cache_database' => ['sometimes', 'integer', 'min:0', 'max:16'],
            'cache_tls' => ['sometimes', 'boolean'],
            'cache_prefix' => ['nullable', 'string', 'max:255'],
            'session_connection_name' => ['sometimes', 'string', 'max:64'],
            'session_host' => ['sometimes', 'string', 'max:255'],
            'session_port' => ['sometimes', 'integer', 'min:1', 'max:65535'],
            'session_database' => ['sometimes', 'integer', 'min:0', 'max:16'],
            'session_tls' => ['sometimes', 'boolean'],
            'session_lifetime_minutes' => ['sometimes', 'integer', 'min:1', 'max:1440'],
