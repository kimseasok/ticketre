...
## [Unreleased]
### Added
- Portal authentication via JWT sessions with tenant/brand scoped models, REST + Filament management, structured logging, audit trails, and OpenAPI/README updates. (E9-F3-I2)
