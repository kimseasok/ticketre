...
- Tenant-aware permission catalog with REST + Filament CRUD, audit logging, tenant-scoped cache keys, and documentation/tests. (E2-F3-I1)
- Tenant- and brand-scoped team management with RBAC APIs, Filament CRUD, audit logging, and OpenAPI/README updates. (E2-F4-I1)
- RBAC middleware enforcement with tenant-aware permission checks, Filament gating, `admin.access` seeding, and access attempt logging. (E2-F3-I3)
...
- Contact and company directory with GDPR consent tracking, tag management, RBAC APIs, Filament CRUD, audit logging, and OpenAPI/README updates. (E2-F1-I2)
